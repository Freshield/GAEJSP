    ...
    <div id="navi_ul">
        ...
        <div id="resources">
            ...
            <div id="VM2" class="resources_row"
                ...
                <div class="resources_cell cell_img"><img src="image/nav_data_pm.png"  class="nav_img" height="24"></div>
                <div id="navname_vm2" class="resources_cell cell_word">PM2 <img id="status_vm2" src="image/halted.png" height="12"></div>
                <div class="resources_cell cell_res"><</div>
            </div>
            <div id="VM3" class="resources_row"   style="background-color: rgb(47,50,58)"
                 onclick="toVmLocation('3');">
                <div class="resources_cell cell_img"><img src="image/nav_data_vm.png"  class="nav_img" height="24"></div>
                <div id="navname_vm3" class="resources_cell cell_word"style="color: rgb(28,168,221)">VM1 <img id="status_vm3" src="image/halted.png" height="12"></div>
                <div class="resources_cell cell_res"><</div>
            </div>
            <div id="VM4" class="resources_row"
                 onclick="toVmLocation('4');">
                <div class="resources_cell cell_img"><img src="image/nav_data_vm.png" class="nav_img"
height="24"></div>
...
<div id="PANEL">
    <div id="PANEL_outline">
        ...
        <header id="PANEL_header">
            <span id="PANEL_header_word">VM1</span>
        ...
        <div id="PANEL_navigator">
            <span id="PANEL_nav_path">
                ...
                <span id="PANEL_path_word">Home  >  VM1</span>
            </span>
...
<script type="text/javascript">
    ...
    xmlhttp3.onreadystatechange = function(){
        if(xmlhttp3.readyState == 4 && xmlhttp3.status == 200){
            ...
            document.getElementById("PANEL_header_word").innerText = jVM1_name;
            document.getElementById("PANEL_path_word").innerText = "Home  >  "+jVM1_name;
    ...
    var xmlhttp2;
    var lineNames=["cpu"]; //保存系列名称
    var lineColor=["rgb(28,168,221)"];
    ...
    function changeData(){
        ...
        for(var i = 0;i<receAmount;i++){
            ...
            datasetrx.shift();
            //dataset.push(Math.round(Math.random()*h));
            dataset.push(parseFloat(receCpu1[i].cpu1));
    ...
    str = "name=flask" + "&timestamp=" + finalTime;
