   ...
   throws ServletException, IOException {
	//generate the timestamp
	   ...
	   try {
           ...
           sql = "select * from vm_table where timestamp>"+timeNow+" and vmname='flask'";
           ...
           sql = "select * from vm_table where timestamp>"+timeNow+" and vmname='flake'";
           System.out.println(sql);
         ...
         //get all data from host_table
           sql = "select * from host_table where timestamp>"+timeNow+" and hostname='worth'";
           System.out.println(sql);
           rs = stmt.executeQuery(sql);// executeQuery会返回结果的集合，否则返回空值
           System.out.println(rs);
           temp = "";
           ...
           sql = "select * from host_table where timestamp>"+timeNow+" and hostname='unhand'";
           System.out.println(sql);
           rs = stmt.executeQuery(sql);// executeQuery会返回结果的集合，否则返回空值
           System.out.println(rs);
           temp = "";
