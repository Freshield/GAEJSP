...
<div id="navigator">
    <div id="navi_ul">
        ...
        <div id="resources">
            ...
            <div id="VM4" class="resources_row"  style="background-color: rgb(47,50,58)"
                 onclick="toVmLocation('4');">
                <div class="resources_cell cell_img"><img src="image/nav_data_vm.png"  class="nav_img" height="24"></div>
                <div id="navname_vm4" class="resources_cell cell_word" style="color: rgb(28,168,221)">VM2 <img id="status_vm4" src="image/halted.png" height="12"></div>
                <div class="resources_cell cell_res"><</div>
            </div>
...
<script type="text/javascript">
    ...
    xmlhttp3.onreadystatechange = function(){
        if(xmlhttp3.readyState == 4 && xmlhttp3.status == 200){
            ...
            document.getElementById("PANEL_header_word").innerText = jVM2_name;
            document.getElementById("PANEL_path_word").innerText = "Home  >  "+jVM2_name;
    ...
    function drawChart() {
        ...
        //----------------------------for network chart----------------------------
        //alert(datasetn);
        //alert(Math.max.apply(Math,datasetn));
        //alert(d3.max(datasetn,function(d){
        //    return d;
        //}))
    ...
    str = "name=flake" + "&timestamp=" + finalTime;
