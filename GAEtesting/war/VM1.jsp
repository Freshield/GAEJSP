...
<div id="navigator">
    <div id="navi_ul">
        ...
        <div id="resources">
            ...
            <div id="VM1" class="resources_row"  style="background-color: rgb(47,50,58)"
                 onclick="toVmLocation('1');">
                <div class="resources_cell cell_img"><img src="image/nav_data_pm.png"  class="nav_img" height="24"></div>
                <div id="navname_vm1" class="resources_cell cell_word"style="color: rgb(28,168,221)">PM1 <img id="status_vm1" src="image/halted.png" height="12"></div>
                <div class="resources_cell cell_res"><</div>
            </div>
...
<div id="PANEL">
    <div id="PANEL_outline">
        ...
        <header id="PANEL_header">
            <span id="PANEL_header_word">PM1</span>
        ...
        <div id="PANEL_navigator">
            <span id="PANEL_nav_path">
                ...
                <span id="PANEL_path_word">Home  >  PM1</span>
            </span>
...
<script type="text/javascript">
    ...
    xmlhttp3.onreadystatechange = function(){
        if(xmlhttp3.readyState == 4 && xmlhttp3.status == 200){
            ...
            document.getElementById("PANEL_header_word").innerText = jPM1_name;
            document.getElementById("PANEL_path_word").innerText = "Home  >  "+jPM1_name;
